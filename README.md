...
[![Latest release](https://img.shields.io/github/v/release/nordbyte/PeekabooX?style=flat-square)](https://github.com/nordbyte/PeekabooX/releases/latest)
[![CI](https://img.shields.io/github/actions/workflow/status/nordbyte/PeekabooX/ci.yml?branch=main&style=flat-square)](https://github.com/nordbyte/PeekabooX/actions/workflows/ci.yml)
[![License: Apache-2.0 OR MIT](https://img.shields.io/badge/License-Apache--2.0%20OR%20MIT-ffd60a?style=flat-square)](Cargo.toml)
[![Linux](https://img.shields.io/badge/Linux-Wayland%20%2B%20X11-0078d7?logo=linux&logoColor=white&style=flat-square)](docs/cli.md)
[![Rust](https://img.shields.io/badge/Rust-2024-F05138?logo=rust&logoColor=white&style=flat-square)](Cargo.toml)
[![Python](https://img.shields.io/badge/Python-%3E%3D3.12-3776ab?logo=python&logoColor=white&style=flat-square)](python/pyproject.toml)

PeekabooX brings screen capture, semantic desktop inspection, safe input
automation, workflow execution, plugins, and MCP-ready agent runtime APIs to
Linux.
