...
WORKFLOW_STEP_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        ...
        "contrast": {"type": "number", "minimum": 0, "maximum": 255},
        ...
        "max_mean_absolute_error": {"type": "number", "minimum": 0, "maximum": 255},
        ...
        "stable_max_mean_absolute_error": {"type": "number", "minimum": 0, "maximum": 255},
        "stable_max_channel_delta": {"type": "integer", "minimum": 0, "maximum": 255},
        ...
        "size_policy": {"type": "string", "enum": ["error", "common-region", "resize-actual"]},
        "alpha": {"type": "string", "enum": ["ignore", "compare"]},
        ...
        "sort": {"type": "string", "enum": ["position", "area", "confidence"]},
        ...
        "assertion": {
            "type": "string",
            "enum": ["present", "not_present", "active", "not_active", "contains", "not_contains"],
        },
