                ...
                _schema(
                    {
                        ...
                        "require_trusted": {"type": "boolean", "default": False},
    ...
    def _call_plugin_tool(self, arguments: dict[str, Any]) -> dict[str, Any]:
        ...
        return _to_mcp_value(
            self._require_runtime().call_plugin_tool(
                ...
                require_trusted=_optional_bool(arguments, "require_trusted"),
                trust_policy_path=_optional_string(arguments, "trust_policy"),
            )
        )
